...
debug_initialize <- function() {
    ...
    node_poke_cdr(as.name(".ark_annotate_source"), .ark_annotate_source)
    node_poke_cdr(as.name(".ark_auto_step"), .ark_auto_step)
    node_poke_cdr(as.name(".ark_breakpoint"), .ark_breakpoint)
    node_poke_cdr(
        as.name(".ark_verify_breakpoints_range"),
