...
//!
//! [`LspHarness`] does not start workers, schedulers, or a client peer, allowing
//! benchmarks to measure a cold diagnostics pass without workspace indexing or
//! revision-driven refreshes. Tests can consume it through [`session`] to drive
//! events against the same database.
