...
fn test_file_by_path_finds_workspace_script() {
    ...
    assert_eq!(db.file_by_path(&file_path("proj/a.R")), Some(file));
}
...
fn test_file_by_path_finds_workspace_package_file() {
    ...
    assert_eq!(db.file_by_path(&file_path("proj/R/foo.R")), Some(file));
}
...
fn test_file_by_path_finds_library_package_file() {
    ...
    assert_eq!(db.file_by_path(&file_path("libs/foo/R/a.R")), Some(file));
}
...
fn test_file_by_path_finds_orphan_file() {
    ...
    assert_eq!(db.file_by_path(&file_path("untitled.R")), Some(file));
}

#[test]
fn test_file_by_path_returns_none_when_absent() {
    let db = TestDb::new();
    assert_eq!(db.file_by_path(&file_path("missing.R")), None);
}
...
fn test_root_path_index_invalidates_per_root() {
    ...
    let _ = db.file_by_path(&file_path("a/file.R"));
